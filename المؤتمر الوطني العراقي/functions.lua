...
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/peace/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/peace/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/peace/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/KDJEONDHOSN/peace/master/inc/functions.lua','./inc/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n🔝*¦* تم تحديث السورس الى اصدار *v'..redis:get(peace..":VERSION")..'*\n📟*¦* تم اعاده تشغيل السورس بنجاح') end
if edit then dofile("./inc/Run.lua") end
print("Update Source And Reload ~ ./inc/Run.lua")

end
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(peace..":NameBot:") or "الزعيم"
...
local Fshar_Word , res = https.request('https://api.th3peace.com/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://api.th3peace.com/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = redis:get(peace..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(peace..':SUDO_BOT:',UserID) then
var = redis:get(peace..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(peace..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(peace..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(peace..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(peace..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(peace..'owners:'..ChatID,UserID) then
var = redis:get(peace..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(peace..'admins:'..ChatID,UserID) then
var = redis:get(peace..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(peace..'whitelist:'..ChatID,UserID) then
var = redis:get(peace..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
local edited = (redis:get(peace..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(peace..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local NameUser = ResolveName(data)
local Emsgs = redis:get(peace..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
Replay = Replay:gsub("{البوت}",redis:get(peace..':NameBot:'))
...
if msg.edited then
redis:incr(peace..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(peace..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(peace..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(peace..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(peace..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(peace..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(peace..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(peace..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(peace..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(peace..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(peace..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(peace..'owners:'..msg.chat_id_)
local Admins = redis:smembers(peace..'admins:'..msg.chat_id_)
local mmez = redis:smembers(peace..'whitelist:'..msg.chat_id_)
...
local info  = redis:hgetall(peace..'username:'..v)
...
local list = redis:smembers(peace..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(peace..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(peace..'username:'..v)
local count = redis:scard(peace..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
...
local monsha = redis:smembers(peace..':MONSHA_Group:'..msg.chat_id_)
if #monsha == 0 then 
...
local list = redis:smembers(peace..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(peace..'admins:'..msg.chat_id_)
...
local list = redis:smembers(peace..'whitelist:'..msg.chat_id_)
...
if redis:sismember(peace..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(peace..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(peace..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(peace..'banned:'..msg.chat_id_)
...
if redis:sismember(peace..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(peace..'gban_users')
...
local list = redis:smembers(peace..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(peace..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(peace..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(peace..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(peace..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(peace..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(peace..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..peace..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(peace..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(peace..'group:name'..GroupS) or '')
...
local admins = redis:smembers(peace..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(peace..'username:'..value)
if info then 
...
local creator = redis:smembers(peace..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(peace..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(peace..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(peace..'group:name'..v)
if info then 
...
redis:del(
peace..'group:add'..id_group,
peace..'lock_link'..id_group, 
peace..'lock_id'..id_group,
peace..'lock_spam'..id_group, 
peace..'lock_webpage'..id_group,
peace..'lock_markdown'..id_group,
peace..'lock_flood'..id_group,
peace..'lock_bots'..id_group,
peace..'mute_forward'..id_group,
peace..'mute_contact'..id_group,
peace..'mute_location'..id_group,
peace..'mute_document'..id_group,
peace..'mute_keyboard'..id_group,
peace..'mute_game'..id_group,
peace..'mute_inline'..id_group,
peace..'lock_username'..id_group,
peace..'num_msg_max'..id_group,
peace..'mute_text'..id_group,
peace..'admins:'..id_group,
peace..':Filter_Word:'..id_group,
peace..'banned:'..id_group,
peace..'is_silent_users:'..id_group,
peace..'whitelist:'..id_group,
peace..':MONSHA_BOT:'..id_group,
peace..'owners:'..id_group,
peace..'replay'..id_group,
peace..':MONSHA_Group:'..id_group
)
redis:srem(peace..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(peace..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(peace..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(peace..'admins:'..arg.chat_id_,data.id_)
...
function modadd(msg)
if redis:get(peace..'lock_service') then
lock_servicez = true
else
lock_servicez = false
end
...
if redis:get(peace..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n📮¦ بواسطه ⋙「 '..NameUser..' 」 \n') end
local UserChaneel = redis:get(peace..":UserNameChaneel")
...
local GroupUsers = tonumber(redis:get(peace..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(peace..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(peace..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
peace..'group:add'..arg.chat_id_,true,
peace..'lock_link'..arg.chat_id_,true, 
peace..'lock_id'..arg.chat_id_,true,
peace..'lock_spam'..arg.chat_id_,true,
peace..'lock_webpage'..arg.chat_id_,true,
peace..'lock_markdown'..arg.chat_id_,true,
peace..'lock_flood'..arg.chat_id_,true,
peace..'lock_bots'..arg.chat_id_,true,
peace..'mute_forward'..arg.chat_id_,true,
peace..'mute_contact'..arg.chat_id_,true,
peace..'mute_location'..arg.chat_id_,true,
peace..'mute_document'..arg.chat_id_,true,
peace..'mute_keyboard'..arg.chat_id_,true,
peace..'mute_game'..arg.chat_id_,true,
peace..'mute_inline'..arg.chat_id_,true,
peace..'lock_username'..arg.chat_id_,true,
peace..'num_msg_max'..arg.chat_id_,5, 
peace..'lock_edit'..arg.chat_id_,true,
peace..'replay'..arg.chat_id_,true,
peace..'lock_rdodSource'..arg.chat_id_,true,
peace.."lock_KickBan"..msg.chat_id_,true,
peace.."lock_mmno3"..msg.chat_id_,true,
peace.."lock_KickBan"..msg.chat_id_,true,
peace.."lock_RandomRdod"..msg.chat_id_,true,
peace.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(peace..'group:ids',arg.chat_id_) 
redis:sadd(peace..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(peace..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(peace..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:sadd(peace..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم تقييده بنجاح \n✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(peace..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده بنجاح \n✓")
end
if cmd == "setwhitelist" then
if redis:sismember(peace..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه \n✓") 
end
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:sadd(peace..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه \n✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(peace..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
end
redis:srem(peace..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مميز  في المجموعه \n✓") 
end
if cmd == "setmnsha" then
if redis:sismember(peace..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه \n✓") 
end
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:sadd(peace..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ  في المجموعه \n✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(peace..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
end
redis:srem(peace..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشى  في المجموعه \n✓") 
end

if cmd == "setowner" then
if redis:sismember(peace..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:sadd(peace..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مدير  في المجموعه \n✓") 
end
if cmd == "remowner" then
if not redis:sismember(peace..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
end
redis:srem(peace..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
if cmd == "promote" then
if redis:sismember(peace..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:sadd(peace..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه ادمن  في المجموعه \n✓") 
end
if cmd == "demote" then
if not redis:sismember(peace..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
end
redis:srem(peace..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(peace..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(peace..'username:'..UserID,'username',USERNAME)
redis:sadd(peace..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(peace..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(peace..':MONSHA_Group:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "up_sudo" then
if redis:sismember(peace..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مطور  في البوت \n✓") 
end
redis:hset(peace..'username:'..UserID, 'username', USERNAME)
redis:sadd(peace..':SUDO_BOT:',UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مطور  في البوت \n✓") 
end

if cmd == "dn_sudo" then
if not redis:sismember(peace..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مطور  في البوت \n✓") 
end
redis:srem(peace..':SUDO_BOT:',UserID) 
...
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:sadd(peace..'banned:'..ChatID,UserID)
...
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:srem(peace..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:sadd(peace..'is_silent_users:'..ChatID,UserID)
...
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:srem(peace..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
end

if cmd == "upMshrf" then
redis:hset(peace..'username:'..UserID,'username',Resolv)
redis:setex(peace..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(peace..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
redis:hset(peace..'username:'..UserID, 'username', Resolv)
redis:sadd(peace..'gban_users',UserID)
kick_user(UserID,ChatID) 
...
redis:srem(peace..'gban_users',UserID)
StatusLeft(ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء حظره العام  من المجموعات \n✓") 
end

if cmd == "tfa3l" then  
local maseegs = redis:get(peace..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(peace..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(peace..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
.."\n📝¦ التعديل » "..(redis:get(peace..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(peace..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(peace..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(peace..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(peace..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(peace..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(peace..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(peace..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(peace..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(peace..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(peace..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰¦ وقت التنظيف » "..(redis:get(peace..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(peace..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(peace..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(peace..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(peace..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(peace..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(peace..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(peace..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(peace..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(peace..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(peace..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(peace..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(peace..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(peace..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(peace..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(peace..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(peace..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(peace..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(peace..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(peace..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود » "..(redis:get(peace..'replay'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود العشوائيه » "..(redis:get(peace.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(peace..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝¦* الايدي » "..(redis:get(peace..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬¦* الرابط » "..(redis:get(peace..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*📮¦* المغادره » "..(redis:get(peace..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳¦* الحظر » "..(redis:get(peace..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍¦* الحمايه » "..(redis:get(peace..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋¦* التاك للكل » "..(redis:get(peace..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒¦* الايدي بالصوره » "..(redis:get(peace..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐¦* التحقق » "..(redis:get(peace.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑¦* التنظيف التلقائي » "..(redis:get(peace.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂¦* ردود السورس » "..(redis:get(peace.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(peace..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(peace..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(peace..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(peace..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(peace..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(peace..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(peace..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(peace..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(peace..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
