...
user.Source  = "/root/peace"
local url , res = https.request('https://api.th3peace.com/GetID/?Array='..JSON.encode(user))
print(res)
if res ~= 200 then
...
peace = Token:match("(%d+)")
redis:mset(
peace..":VERSION",GetUser.information.Source_version,
peace..":SUDO_ID:",GetUser.information.id,
peace..":DataCenter:",GetUser.information.DataCenter,
peace..":UserNameBot:",BOT_User,
peace..":ApiSource",GetUser.information.WebSite,
peace..":NameBot:","حمد",
"TH3peace_INSTALL","Yes"
)
redis:hset(peace..'username:'..GetUser.information.id,'username','@'..GetUser.information.username:gsub('_',[[\_]]))
info = {} 
...
peace = Token:match("(%d+)")
our_id = tonumber(peace)
Apipeace = redis:get(peace..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(peace..":UserNameBot:")
SUDO_ID = tonumber(redis:get(peace..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(peace..'username:'..SUDO_ID).username
version = redis:get(peace..":VERSION")
DataCenter = redis:get(peace..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..peace..')\027[0;32m\n'
...
..'¦ Api_Src->: \27[1;34m'..Apipeace..'\027[0;32m\n'
...
if not redis:get(peace..":Check_Bot:"..W) then
Rgz,res=https.request(Apipeace..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(peace..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(peace..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(peace..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(peace..'group:add'..msg.chat_id_) then 
...
and redis:get(peace.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(peace..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(peace..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(peace..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end



local Cleaner = redis:smembers(peace..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
if not redis:get(peace..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(peace..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(peace..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end 
...
msg.TheRankCmd = redis:get(peace..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(peace..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(peace..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(peace..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(peace..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(peace..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(peace..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(peace..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(peace..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(peace..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(peace..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(peace..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(peace..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(peace..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(peace..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(peace..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(peace..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(peace..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(peace..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(peace..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(peace..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(peace..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(peace..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(peace..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(peace..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(peace.."lock_Add"..msg.chat_id_) then
...
if redis:get(peace..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
return false 
else
if redis:get(peace.."lock_check"..msg.chat_id_) and not redis:get(peace..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(peace..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(peace..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(peace..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.peace then 
if msg.text and ScriptFile.ipeace then
Xpeace = ScriptFile.peace
local list = redis:hgetall(peace..":AwamerBotArray:"..msg.chat_id_)
for peace2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(peace2) then 
local amrr = {Text:match(peace2)}
local AmrOld = redis:hgetall(peace..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.ipeace(msg,{Text:match(Text2)})
if GetMsg then
...
for k, peace in pairs(Xpeace) do
Text = msg.text
Text = Text:gsub("ی","ي")
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(peace) then -- Check Commands To admin
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end 
GetMsg = ScriptFile.ipeace(msg,{Text:match(peace)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",peace.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dpeace then
if ScriptFile.dpeace(msg) == false then
return false
end
...
if Plug.peace then 
if msg.text and Plug.ipeace then
for k, peace in pairs(Plug.peace) do
if msg.text:match(peace) then
local GetMsg = Plug.ipeace(msg,{msg.text:match(peace)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",peace.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
print("The File "..name.." Not Runing in The Source peace")
end 

end
else
print("The File Script.lua Not Runing in The Source peace")
end
end
...
redis:srem(peace..'users',msg.sender_user_id_)
end
...
if redis:get(peace..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(peace..":propin"..msg.chat_id_)
...
if redis:get(peace..'group:add'..data.chat_.id_) then
redis:set(peace..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(peace..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(peace..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(peace..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
peace..'group:name'..k,IDS.Title,
peace..'num_msg_max'..k,5,
peace..'group:add'..k,true,
peace..'lock_link'..k,true,
peace..'lock_spam'..k,true,
peace..'lock_webpage'..k,true,
peace..'lock_markdown'..k,true,
peace..'lock_flood'..k,true,
peace..'lock_bots'..k,true,
peace..'mute_forward'..k,true,
peace..'mute_contact'..k,true,
peace..'mute_document'..k,true,
peace..'mute_inline'..k,true,
peace..'lock_username'..k,true,
peace..'replay'..k,true
)
redis:sadd(peace..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(peace..'username:'..ID,'username',user)
redis:sadd(peace..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(peace..'username:'..ID,'username',user)
redis:sadd(peace..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(peace..'username:'..ID,'username',user)
redis:sadd(peace..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(peace..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(peace..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(peace..'username:'..data.user_.id_).username
...
redis:hset(peace..'username:'..data.user_.id_,'username',USERNAME)
end 
end
